"function" != typeof Object.create &&
  ...
  (function (t, o, i, s) {
    ...
    var n = {
      ...
      getTargetBottomHeight(isBelowAtc) {
        try{
      ...
      position: function () {
        const atcButton = document.querySelector("#AddToCart-product-template");
        const isBelowAtc = this.checkVisible(atcButton, 121, "above");
        const bottomHeight = this.getTargetBottomHeight(isBelowAtc);
